...
- Kotlin 1.9 + Android SDK (Min 24), Material Components, Supabase Auth, Retrofit 2, OkHttp 4 (013-auth-register)
...
# Add commands for Kotlin 1.9+, Android SDK 35+
...
## Recent Changes
- 013-auth-register: Added Kotlin 1.9 + Android SDK (Min 24), Material Components, Supabase Auth, Retrofit 2, OkHttp 4
